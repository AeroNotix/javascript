...
export const APIS = [AdmissionregistrationApi, AdmissionregistrationV1Api, ApiextensionsApi, ApiextensionsV1Api, ApiregistrationApi, ApiregistrationV1Api, ApisApi, AppsApi, AppsV1Api, AuthenticationApi, AuthenticationV1Api, AuthorizationApi, AuthorizationV1Api, AutoscalingApi, AutoscalingV1Api, AutoscalingV2Api, AutoscalingV2beta1Api, AutoscalingV2beta2Api, BatchApi, BatchV1Api, BatchV1beta1Api, CertificatesApi, CertificatesV1Api, CoordinationApi, CoordinationV1Api, CoreApi, CoreV1Api, CustomObjectsApi, DiscoveryApi, DiscoveryV1Api, DiscoveryV1beta1Api, EventsApi, EventsV1Api, EventsV1beta1Api, FlowcontrolApiserverApi, FlowcontrolApiserverV1beta1Api, FlowcontrolApiserverV1beta2Api, InternalApiserverApi, InternalApiserverV1alpha1Api, LogsApi, NetworkingApi, NetworkingV1Api, NodeApi, NodeV1Api, NodeV1beta1Api, OpenidApi, PolicyApi, PolicyV1Api, PolicyV1beta1Api, RbacAuthorizationApi, RbacAuthorizationV1Api, SchedulingApi, SchedulingV1Api, StorageApi, StorageV1Api, StorageV1beta1Api, VersionApi, WellKnownApi];
